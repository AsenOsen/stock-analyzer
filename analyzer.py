...
class TickerRating():
	...
	def getIndicators():
		return {
			...
			# positve behaviour
			'getOptionsPositive': {'in':'Позитивный настрой по опционам', 'out':'Нет позитивного настроя по опционам'},
			...
			'getSocialAttitudeGood': {'in':'Позитивный социальный настрой', 'out':'Нет позитивного социального настроя'}
		}
